...
# ilch Script (c) by Manuel Staechele
...
$script_name = 'Rekrutierungs Box';    // Name des Moduls
$script_vers = '1.0';        // Version des Moduls
$ilch_vers = '1.1';        // Version des ilch Scripts
$ilch_update = 'P';         // Update des ilch Scripts
...
$hmenu = $script_name . ' Vers.: ' . $script_vers . ' f&uuml;r ilch ' . $ilch_vers . ' Vers.: ' . $ilch_update;
...
if (!isset($_POST['do'])) {
    ...
    ?>
    <form action="index.php?wowrecruit_install" method="POST">
            ...
            <tr class="Cmite">
                <td align="center">
                    ...
                    <div style="margin-left:60px; text-align:left;">
                        ...
                        <br />
                        <br />
                        Entwickelt f&uuml;r ilch Version <strong><?php echo $ilch_vers; ?> <?php echo $ilch_update; ?></strong>.<br />
                        <br />
    ...
    $error = '';
    $sql_file = implode('', file('include/contents/wowrecruit_install.sql'));
    ...
    <table width="97%" class="border" border="0" cellspacing="1" cellpadding="3" align="center">
        ...
        <tr class="Cmite">
            <td colspan="3" align="center">
                ...
                if (!empty($error)) {
                    ...
                    $fehler .= '<br /><br />Oben sollten Sie eine ausf&uuml;hrlichere Fehlermeldung sehen<br />(ab ilch Version 1.1 I).';
                    ...
                    if (@unlink('include/contents/wowrecruit_install.php') && @unlink('include/contents/wowrecruit_install.sql')) {
                        $erfolg .= '<br /><br />Diese Installationsdateien wurden erfolgreich gel&ouml;scht. Es muss nichts mehr getan werden.';
                    } else {
                        $erfolg .= '<br /><br /><strong>Die Installationsdateien konnten nicht automatisch gel&ouml;scht werden. L&ouml;schen Sie folgende Dateien:</strong><br /><br /><i>include/contents/wowrecruit_install.php</i><br /><i>include/contents/wowrecruit_install.sql</i>';
                    }
        ...
        <tr class="Chead">
            <td colspan="3" align="center">
                <button onclick="javascript:window.location.href = 'index.php?user-details-1';">Zum Admin Profil</button>
            </td>
        </tr>
    </table>
    </td>
